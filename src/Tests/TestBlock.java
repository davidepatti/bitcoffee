...
public class TestBlock {
    ...
    public static void main(String[] args) {
        ...
        Test.__BEGIN_TEST("bitcoffee.Block");
        ...
        Test.check("bitcoffee.Block Hashes",desc,target_hash,hash);
        Test.__END_TEST();
        ...
        System.out.println("Tests.Test difficulty: "+(difficulty==888171856257.0));
