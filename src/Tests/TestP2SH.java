...
public class TestP2SH {
    public static void main(String[] args) {
        ...
        System.out.println("----------------------------------------------------");
        System.out.println(">> TEST Validating bitcoffee.Signature with Redeem bitcoffee.Script ");
        ...
        try {
            ...
            // modify the single bitcoffee.TxIn to have the ScriptSig to be the RedeemScript
            ...
            System.out.println(">> RESULT Redeem bitcoffee.Script verification: "+point.verify(new BigInteger(1,z),sig));
