...
public class TestTransactions {
    public static void main(String[] args) {
        ...
        System.out.println("--------------------------------------------------------");
        System.out.println(">> Tests.Test: Transaction decoding");
...
"a87988ac005a6202000000001976a9143c82d7df364eb6c75be8c80df2b3eda8db57397088ac46430600";
        ...
        Tx tx = Tx.parse(Kit.hexStringToByteArray(trans),false);
        System.out.println("Transaction parsed:");
        System.out.println(tx);


        var res_script_sig = Kit.bytesToHexString(tx.getTxIns().get(1).getScriptSig());
        var res_script_pubkey = Kit.bytesToHexString(tx.getTxOuts().get(1).getScriptPubkeyBytes());
        ...
        System.out.print(">> Tests.Test Calculated fee: "+fee);
        long target_fee = 140500;
        if (fee==target_fee) System.out.println(" Tests.Test fee OK!");
        else
            System.out.println(" Tests.Test fee ERROR");
        ...
        System.out.println(">> Tests.Test fetching Transaction");
        System.out.println("tx_id:"+target_tx_id);
        var tx_result = TxFetcher.fetch(target_tx_id,false,true);
        System.out.println("bitcoffee.Tx result:"+tx_result);
