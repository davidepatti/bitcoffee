...
public class TestMerkle {
    ...
    public static void main(String[] args) {
        ...
        Test.__BEGIN_TEST("bitcoffee.MerkleBlock");
        ...
        Test.__BEGIN_TEST("bitcoffee.MerkleBlock isValid()");

        /*
        var tm = new bitcoffee.MerkleTree(7);
        var ff = bitcoffee.MerkleBlock.bitStringToBitField("10111000");
        ...
        Test.check("Merkle bitcoffee.Block validity",""+mb,true, Objects.requireNonNull(mb).isValid());
