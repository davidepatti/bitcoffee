...
public class TestSerialization {
    public static void main(String[] args) {
        ...
        var les3 = CryptoKit.bytesToHexString(le_bytes3);
        ...
        les3 = CryptoKit.bytesToHexString(leb3);
        System.out.println(les3);
        ...
        long result_n = CryptoKit.readVarint(CryptoKit.hexStringToByteArray(hex_string));
        System.out.println("Result:"+(target_n==result_n));

        hex_string = "fdff00";
        target_n = 255;
        System.out.println("hex="+hex_string+ " target_n="+target_n);
        result_n = CryptoKit.readVarint(CryptoKit.hexStringToByteArray(hex_string));
