...
public class TestScript {
    ...
    public static void main(String args[]) {
        ...
        System.out.println(test_script.evaluate());
        System.out.println("------------------------------------------------------");
        ...
        var sig = CryptoKit.hexStringToByteArray("3045022000eff69ef2b1bd93a66ed5219add4fb51e11a840f4048" +
                "76325a1e8ffe0529a2c022100c7207fee197d27c618aea621406f6bf5ef6fca38681d82b2f06fd" + "dbdce6feab601");
        ...
        System.out.println("Combined script:");
        System.out.println(combined_script);

        System.out.println(combined_script.evaluate());
