...
public class TestBlock {
    ...
    public static void main(String[] args) {
        var test = new Test<String>("Block");
        test.begin();
        ...
        var block_reserialized = Kit.bytesToHexString(block.serializeHeader());
        ...
        var test2 = new Test<Boolean>("BIP9");
        test2.begin();
        test2.check("bip9","block hash:"+block.getHashHexString(),true,block.checkBIP9());
        ...
        test2.check("bip9","block hash:"+block.getHashHexString(),false,block.checkBIP9());
        ...
        test2.check("bip91","block hash:"+block.getHashHexString(),true,block.checkBIP91());
        ...
        test2.check("bip91","block hash:"+block.getHashHexString(),false,block.checkBIP91());

        block  = Block.parseSerial(Kit.hexStringToByteArray("020000208ec39428b17323fa0ddec8e887b4a7c53b8c0a0a220cfd0000000000000000005b0750fce0a889502d40508d39576821155e9c9e3f5c3157f961db38fd8b25be1e77a759e93c0118a4ffd71d"));
        test2.check("bip141","block hash:"+block.getHashHexString(),true,block.checkBIP141());
        ...
        test2.check("bip141","block hash:"+block.getHashHexString(),false,block.checkBIP141());

        test2.end();

        ///////////////////////////////////////////////////////////////////
        var test3 = new Test<String>("Proof-of-Work");
        test3.begin();

        block = Block.parseSerial(Kit.hexStringToByteArray("020000208ec39428b17323fa0ddec8e887b4a7c53b8c0a0a220cfd0000000000000000005b0750fce0a889502d40508d39576821155e9c9e3f5c3157f961db38fd8b25be1e77a759e93c0118a4ffd71d"));
        var target = "13ce9000000000000000000000000000000000000000000";
        var computed_target = block.getTarget().toString(16);
        test3.check("bitsToTarget","block:"+block.getSerialHeaderString(),target,computed_target);


        //////////////////////////////////////////////////////////////////////////////
        Test.__BEGIN_FREE_TEST("checkPow()");
        ...
        var test4 = new Test<String>("Difficulty adjustment");
        test4.begin();
        ...
        Test.__BEGIN_FREE_TEST("Adjustament parameters");
        ...
        test4.check("ComputeNewBits","80df6217",Kit.bytesToHexString(new_bits));
        test4.end();
