...
public class TestBlock {
    ...
    public static void main(String[] args) {
        ...
        Test.check("bip9","block hash:"+block.getHashHexString(),false,block.checkBIP9());
        ...
        Test.check("bip91","block hash:"+block.getHashHexString(),true,block.checkBIP91());
        ...
        Test.check("bip91","block hash:"+block.getHashHexString(),false,block.checkBIP91());

        block  = Block.parseSerial(Kit.hexStringToByteArray("020000208ec39428b17323fa0ddec8e887b4a7c53b8c0a0a220cfd0000000000000000005b0750fce0a889502d40508d39576821155e9c9e3f5c3157f961db38fd8b25be1e77a759e93c0118a4ffd71d"));
        Test.check("bip141","block hash:"+block.getHashHexString(),true,block.checkBIP141());
        ...
        Test.check("bip141","block hash:"+block.getHashHexString(),false,block.checkBIP141());
