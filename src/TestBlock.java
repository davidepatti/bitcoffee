...
public class TestBlock {
    ...
    public static void main(String[] args) {
        ...
        var block = Block.parseSerial(CryptoKit.hexStringToByteArray(block_raw));

        System.out.println(block);

        System.out.println("Reserialized:");

        System.out.println(CryptoKit.bytesToHexString(block.serialize()));
        ...
        block = Block.parseSerial(CryptoKit.hexStringToByteArray("0400000039fa821848781f027a2e6dfabbf6bda920d9ae61b63400030000000000000000ecae536a304042e3154be0e3e9a8220e5568c3433a9ab49ac4cbb74f8df8e8b0cc2acf569fb9061806652c27"));

        System.out.println(">> Test BIP9 (should  be FALSE)");
        System.out.println(block.checkBIP9());

        System.out.println(">> Test BIP91 (should be TRUE");
        block = Block.parseSerial(CryptoKit.hexStringToByteArray("1200002028856ec5bca29cf76980d368b0a163a0bb81fc192951270100000000000000003288f32a2831833c31a25401c52093eb545d28157e200a64b21b3ae8f21c507401877b5935470118144dbfd1"));
        System.out.println(block.checkBIP91());

        block = Block.parseSerial(CryptoKit.hexStringToByteArray("020000208ec39428b17323fa0ddec8e887b4a7c53b8c0a0a220cfd0000000000000000005b0750fce0a889502d40508d39576821155e9c9e3f5c3157f961db38fd8b25be1e77a759e93c0118a4ffd71d"));
        ...
        block  = Block.parseSerial(CryptoKit.hexStringToByteArray("0000002066f09203c1cf5ef1531f24ed21b1915ae9abeb691f0d2e0100000000000000003de0976428ce56125351bae62c5b8b8c79d8297c702ea05d60feabb4ed188b59c36fa759e93c0118b74b2618"));
        ...
        block = Block.parseSerial(CryptoKit.hexStringToByteArray("04000000fbedbbf0cfdaf278c094f187f2eb987c86a199da22bbb20400000000000000007b7697b29129648fa08b4bcd13c9d5e60abb973a1efac9c8d573c71c807c56c3d6213557faa80518c3737ec1'"));
        ...
        block = Block.parseSerial(CryptoKit.hexStringToByteArray("04000000fbedbbf0cfdaf278c094f187f2eb987c86a199da22bbb20400000000000000007b7697b29129648fa08b4bcd13c9d5e60abb973a1efac9c8d573c71c807c56c3d6213557faa80518c3737ec0"));
        System.out.println(">> Checking PoW for block hash id:"+block.getHashHexString());
        System.out.println("Difficulty:"+block.difficulty());
        System.out.println("Target: "+block.getTargetHexString());
        System.out.println("Check PoW:"+block.checkPoW());
        ...
        var prev_bits = CryptoKit.hexStringToByteArray("54d80118");
        var time_diff = 302400;
        var target_bits = CryptoKit.hexStringToByteArray("00157617");
